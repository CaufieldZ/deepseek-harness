/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-vscode-profile`.
 * @module @deepseek-ai/dsh-vscode-profile/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-vscode-profile'

/** Cordis companion plugin name. */
export const name = 'vscode-profile-bundle-invariant'
